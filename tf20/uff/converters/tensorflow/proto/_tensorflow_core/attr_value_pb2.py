...
# source: _tensorflow_core/attr_value.proto
...
from _tensorflow_core import tensor_pb2 as __tensorflow__core_dot_tensor__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='_tensorflow_core/attr_value.proto',
  package='_tensorflow',
  syntax='proto3',
  serialized_pb=_b('\n!_tensorflow_core/attr_value.proto\x12\x0b_tensorflow\x1a\x1d_tensorflow_core/tensor.proto\x1a#_tensorflow_core/tensor_shape.proto\x1a\x1c_tensorflow_core/types.proto\"\xaf\x04\n\tAttrValue\x12\x0b\n\x01s\x18\x02 \x01(\x0cH\x00\x12\x0b\n\x01i\x18\x03 \x01(\x03H\x00\x12\x0b\n\x01\x66\x18\x04 \x01(\x02H\x00\x12\x0b\n\x01\x62\x18\x05 \x01(\x08H\x00\x12%\n\x04type\x18\x06 \x01(\x0e\x32\x15._tensorflow.DataTypeH\x00\x12.\n\x05shape\x18\x07 \x01(\x0b\x32\x1d._tensorflow.TensorShapeProtoH\x00\x12*\n\x06tensor\x18\x08 \x01(\x0b\x32\x18._tensorflow.TensorProtoH\x00\x12\x30\n\x04list\x18\x01 \x01(\x0b\x32 ._tensorflow.AttrValue.ListValueH\x00\x12)\n\x04\x66unc\x18\n \x01(\x0b\x32\x19._tensorflow.NameAttrListH\x00\x12\x15\n\x0bplaceholder\x18\t \x01(\tH\x00\x1a\xed\x01\n\tListValue\x12\t\n\x01s\x18\x02 \x03(\x0c\x12\r\n\x01i\x18\x03 \x03(\x03\x42\x02\x10\x01\x12\r\n\x01\x66\x18\x04 \x03(\x02\x42\x02\x10\x01\x12\r\n\x01\x62\x18\x05 \x03(\x08\x42\x02\x10\x01\x12\'\n\x04type\x18\x06 \x03(\x0e\x32\x15._tensorflow.DataTypeB\x02\x10\x01\x12,\n\x05shape\x18\x07 \x03(\x0b\x32\x1d._tensorflow.TensorShapeProto\x12(\n\x06tensor\x18\x08 \x03(\x0b\x32\x18._tensorflow.TensorProto\x12\'\n\x04\x66unc\x18\t \x03(\x0b\x32\x19._tensorflow.NameAttrListB\x07\n\x05value\"\x94\x01\n\x0cNameAttrList\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x31\n\x04\x61ttr\x18\x02 \x03(\x0b\x32#._tensorflow.NameAttrList.AttrEntry\x1a\x43\n\tAttrEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12%\n\x05value\x18\x02 \x01(\x0b\x32\x16._tensorflow.AttrValue:\x02\x38\x01\x42\x30\n\x18org.tensorflow.frameworkB\x0f\x41ttrValueProtosP\x01\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[__tensorflow__core_dot_tensor__pb2.DESCRIPTOR,__tensorflow__core_dot_tensor__shape__pb2.DESCRIPTOR,__tensorflow__core_dot_types__pb2.DESCRIPTOR,])
...
_ATTRVALUE_LISTVALUE = _descriptor.Descriptor(
  name='ListValue',
  full_name='_tensorflow.AttrValue.ListValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='_tensorflow.AttrValue.ListValue.s', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i', full_name='_tensorflow.AttrValue.ListValue.i', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='f', full_name='_tensorflow.AttrValue.ListValue.f', index=2,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='b', full_name='_tensorflow.AttrValue.ListValue.b', index=3,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='type', full_name='_tensorflow.AttrValue.ListValue.type', index=4,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='shape', full_name='_tensorflow.AttrValue.ListValue.shape', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='_tensorflow.AttrValue.ListValue.tensor', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='func', full_name='_tensorflow.AttrValue.ListValue.func', index=7,
...
_ATTRVALUE = _descriptor.Descriptor(
  name='AttrValue',
  full_name='_tensorflow.AttrValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='_tensorflow.AttrValue.s', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i', full_name='_tensorflow.AttrValue.i', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='f', full_name='_tensorflow.AttrValue.f', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='b', full_name='_tensorflow.AttrValue.b', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='_tensorflow.AttrValue.type', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shape', full_name='_tensorflow.AttrValue.shape', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='_tensorflow.AttrValue.tensor', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='list', full_name='_tensorflow.AttrValue.list', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='func', full_name='_tensorflow.AttrValue.func', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='placeholder', full_name='_tensorflow.AttrValue.placeholder', index=9,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='_tensorflow.AttrValue.value',
...
_NAMEATTRLIST_ATTRENTRY = _descriptor.Descriptor(
  name='AttrEntry',
  full_name='_tensorflow.NameAttrList.AttrEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='_tensorflow.NameAttrList.AttrEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='_tensorflow.NameAttrList.AttrEntry.value', index=1,
...
_NAMEATTRLIST = _descriptor.Descriptor(
  name='NameAttrList',
  full_name='_tensorflow.NameAttrList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='_tensorflow.NameAttrList.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='attr', full_name='_tensorflow.NameAttrList.attr', index=1,
...
_ATTRVALUE_LISTVALUE.fields_by_name['type'].enum_type = __tensorflow__core_dot_types__pb2._DATATYPE
_ATTRVALUE_LISTVALUE.fields_by_name['shape'].message_type = __tensorflow__core_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['tensor'].message_type = __tensorflow__core_dot_tensor__pb2._TENSORPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['func'].message_type = _NAMEATTRLIST
_ATTRVALUE_LISTVALUE.containing_type = _ATTRVALUE
_ATTRVALUE.fields_by_name['type'].enum_type = __tensorflow__core_dot_types__pb2._DATATYPE
_ATTRVALUE.fields_by_name['shape'].message_type = __tensorflow__core_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE.fields_by_name['tensor'].message_type = __tensorflow__core_dot_tensor__pb2._TENSORPROTO
...
AttrValue = _reflection.GeneratedProtocolMessageType('AttrValue', (_message.Message,), dict(
  ...
  ListValue = _reflection.GeneratedProtocolMessageType('ListValue', (_message.Message,), dict(
    ...
    __module__ = '_tensorflow_core.attr_value_pb2'
    # @@protoc_insertion_point(class_scope:_tensorflow.AttrValue.ListValue)
    ))
  ,
  DESCRIPTOR = _ATTRVALUE,
  __module__ = '_tensorflow_core.attr_value_pb2'
  # @@protoc_insertion_point(class_scope:_tensorflow.AttrValue)
  ))
...
NameAttrList = _reflection.GeneratedProtocolMessageType('NameAttrList', (_message.Message,), dict(
  ...
  AttrEntry = _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), dict(
    ...
    __module__ = '_tensorflow_core.attr_value_pb2'
    # @@protoc_insertion_point(class_scope:_tensorflow.NameAttrList.AttrEntry)
    ))
  ,
  DESCRIPTOR = _NAMEATTRLIST,
  __module__ = '_tensorflow_core.attr_value_pb2'
  # @@protoc_insertion_point(class_scope:_tensorflow.NameAttrList)
  ))
