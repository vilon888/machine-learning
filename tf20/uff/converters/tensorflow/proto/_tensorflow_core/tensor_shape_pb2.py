...
# source: _tensorflow_core/tensor_shape.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='_tensorflow_core/tensor_shape.proto',
  package='_tensorflow',
  syntax='proto3',
  serialized_pb=_b('\n#_tensorflow_core/tensor_shape.proto\x12\x0b_tensorflow\"{\n\x10TensorShapeProto\x12.\n\x03\x64im\x18\x02 \x03(\x0b\x32!._tensorflow.TensorShapeProto.Dim\x12\x14\n\x0cunknown_rank\x18\x03 \x01(\x08\x1a!\n\x03\x44im\x12\x0c\n\x04size\x18\x01 \x01(\x03\x12\x0c\n\x04name\x18\x02 \x01(\tB2\n\x18org.tensorflow.frameworkB\x11TensorShapeProtosP\x01\xf8\x01\x01\x62\x06proto3')
)
...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(
  name='Dim',
  full_name='_tensorflow.TensorShapeProto.Dim',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='_tensorflow.TensorShapeProto.Dim.size', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='_tensorflow.TensorShapeProto.Dim.name', index=1,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='_tensorflow.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='_tensorflow.TensorShapeProto.dim', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unknown_rank', full_name='_tensorflow.TensorShapeProto.unknown_rank', index=1,
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), dict(
  ...
  Dim = _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), dict(
    ...
    __module__ = '_tensorflow_core.tensor_shape_pb2'
    # @@protoc_insertion_point(class_scope:_tensorflow.TensorShapeProto.Dim)
    ))
  ,
  DESCRIPTOR = _TENSORSHAPEPROTO,
  __module__ = '_tensorflow_core.tensor_shape_pb2'
  # @@protoc_insertion_point(class_scope:_tensorflow.TensorShapeProto)
  ))
