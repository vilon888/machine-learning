...
def download_ptb():
    """
    Download dataset from http://www.fit.vutbr.cz/~imikolov/rnnlm/simple-examples.tgz
    Returns:
        Return a path string to store the unziped dataset
    """
    path = tf.keras.utils.get_file('simple-examples.tgz',
                                   "http://www.fit.vutbr.cz/~imikolov/rnnlm/simple-examples.tgz",
                                   extract=True)
    return os.path.join(os.path.dirname(path), "simple-examples/data")
